...
func TestWithEx(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "int", args: args{key: "int", v: 1,  opt: WithEx(10 * time.Millisecond)}, sleep: 0, want: true},
		{name: "int", args: args{key: "int", v: 1,  opt: WithEx(10 * time.Millisecond)}, sleep: 10 * time.Millisecond, want: false},
		{name: "int", args: args{key: "int",  v: 1, opt: WithEx(100 * time.Millisecond)}, sleep: 50 * time.Millisecond, want: true},
	}
	mockCache()
